            ...
            <a href="/graph-databases-book/?ref=home">
              <div class="feature-box_inner oreilly-book" data-equalizer-watch>
                ...
                <div class="book-container">
                  <img class="feature-box_icon aligncenter book"
                       src="https://s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads/20170905105338/graph_databases_book.jpg" />
                </div>
          ...
          <div class="feature-box feature-box--card medium-4 columns text-center">
            <a href="/sandbox-v2/?ref=hcard">
              <div class="feature-box_inner sandbox" data-equalizer-watch>
                <div class="book-spacer"></div>
                <div class="book-container">
                  <img style="margin-bottom: 43px;" class="icon-circle-bg aligncenter more-margin" src="https://s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads/20171129112058/sandbox_icon_solid.svg">
                </div>
                <h2 class="feature-box_title">
          ...
          <div class="feature-box feature-box--card medium-4 columns text-center">
            <a href="/whitepapers/graph-databases-beginners-ebook/?ref=home">
              <div class="feature-box_inner beginners-book" data-equalizer-watch>
                ...
                <div class="book-container">
                  <img class="feature-box_icon aligncenter book"
                       src="https://s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads/20180309150421/Graph-DB-for-Beginners_cover.jpg" />
                </div>
                <h2 class="feature-box_title">
